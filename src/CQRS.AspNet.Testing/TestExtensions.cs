...
public static class TestExtensions
{
    ...
    {
        testApplication.ConfigureHostBuilder(builder => builder.ConfigureAppConfiguration((context, configurationBuilder) => configurationBuilder.AddInMemoryCollection(new Dictionary<string, string?> { { key, value } })));
